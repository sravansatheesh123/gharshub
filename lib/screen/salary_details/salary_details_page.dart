...
class SalaryDetailsPage extends StatelessWidget {
  ...
  final MonthlyTimesheetController timesheetController =
  Get.put(MonthlyTimesheetController());
            ...
            children: [
              ...
              Container(
                ...
                child: SingleChildScrollView(
                  ...
                  child: SizedBox(
                    width: 650, // ✅ give fixed width for row content (adjust if needed)
                    child: ListView.builder(
                      itemCount: timesheetList.length,
                      physics: const BouncingScrollPhysics(), // ✅ Vertical scroll
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    ...
                                    child: Align(
                                      ...
                                      child: AppText(item.totalHours == "-" ? "-" : item.totalHours),
                                    ),
                                  ),
                                ],
                              ),
                  ...
                  children: [
                    ...
                    CustomButton(
                      onTap: () async {
                        ...
                        await dashboardController.getUserId();
